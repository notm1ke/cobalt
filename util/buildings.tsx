...
export enum BuildingCode {
    ...
    AUST = "Austin",
    AVPT = "Avery Point",
    B1 = "Biobehavioral Sci #1",
    B3 = "Biobehavioral Sci #3",
    B4_A = "Biobehavioral Sci #4",
    B5 = "Biobehavioral Sci #5",
    BCH = "Beach Hall",
    BRAN = "Branford House",
    BISH = "Bishop",
    BOUS = "Bousfield",
    ...
    CPB = "Cmty & Professional Building",
    ...
    SRH = "Sprague Hall",
    STRS = "Storrs Hall",
    STRSWW = "Storrs Hall Widmer Wing",
    SU = "Student Union",
...
export enum BuildingAddresses {
    ...
    WREC = '99 E Main St, Waterbury, CT 06702',
...
export enum BuildingDescriptions {
    ...
    ACDS = 'The Avery Point Academic Building (ACDS) is one of the primary academic buildings on the Avery Point campus.',
    ...
    CPB = 'The Community and Professional Studies Building (CPB) is an academic building on the Avery Point campus.',
    ...
    DWTN = 'The Stamford Downtown Campus (DWTN) is located in the heart of Stamford, Connecticut. This space is the Stamford campus\' primary academic building.',
    ...
    HSSW = 'The Hartford School of Social Work Building (HSSW) hosts classes and has study spaces.',
    HPL = 'The Hartford Public Library has a dedicated space for UConn students to study, and for classes.',
    HTB = 'The Hartford Times Building is the primary academic building for the Hartford campus.',
    ...
    USRH = 'The Stamford Residence Hall (USRH) is a residential building for students at the Stamford campus.',
    ...
    WREC = 'The Waterbury Rectory Building (WREC) is an academic building on the Waterbury campus.',
    ...
    WTBY = 'The Waterbury Academic Building (WTBY) is one of the primary academic buildings on the Waterbury campus.',
...
export enum BuildingMaps {
    ...
    WREC = 'https://www.google.com/maps/place/UConn+Waterbury/@41.5554695,-73.039325,17z/data=!4m7!3m6!1s0x89e7c10036940b05:0x664b6276ac19291c!8m2!3d41.5556838!4d-73.0385898!15sChp3YXRlcmJ1cnkgcmVjdG9yeSBidWlsZGluZ5IBCnVuaXZlcnNpdHngAQA!16s%2Fg%2F1tcy5bd9?entry=tts',
...
export const Sites: SiteMap = {
    'avery_point': ['ACDS', 'AVPT', 'BRAN', 'CPB', 'LWB'],
    ...
    'storrs': Object
        ...
        .filter(key => key !== 'ACDS' && key !== 'AVPT' && key !== 'BRAN' && key != 'CPB' && key !== 'LWB' // avpt
...
export const ResidentialBuildings: ResolvableBuildingCode[] = [
    'SPRH', 'SRH', 'USRH', 'WSRHA'
]
...
export const detectSiteFromBuilding = (building: ResolvableBuildingCode): SiteOrUnknown =>
    Object
        .keys(Sites)
